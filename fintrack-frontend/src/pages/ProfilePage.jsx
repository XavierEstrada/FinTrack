    ...
    <div className="max-w-2xl space-y-5">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm">
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            <p className="text-sm font-medium text-slate-800 dark:text-slate-100">{mockUser.full_name}</p>
            <p className="text-xs text-slate-400 dark:text-slate-500 mb-2">{mockUser.email}</p>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm">
        ...
        <div className="mt-6 pt-5 border-t border-slate-100 dark:border-slate-800 flex justify-end">
          <button
            onClick={handleSave}
            className="flex items-center gap-2 bg-indigo-600 text-white text-sm font-medium px-5 py-2 rounded-lg hover:bg-indigo-700 transition-colors"
          >
            <Save size={15} />
            Guardar cambios
          </button>
